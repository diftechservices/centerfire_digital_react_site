...
const MissionControlMustache = () => {
  ...
  const missionControl = content.missionControl
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display font-black text-5xl lg:text-6xl mb-6">
            <span className="text-white">{missionControl.titleLine1}</span>
            <span className="text-fire-orange"> {missionControl.titleLine2}</span>
          </h2>
...
export default MissionControlMustache